...
@Component({
  selector: 'app-team-arrange',
  templateUrl: './team-arrange.component.html',
  styleUrls: ['./team-arrange.component.scss']
})
export class TeamArrangeComponent implements OnInit {
